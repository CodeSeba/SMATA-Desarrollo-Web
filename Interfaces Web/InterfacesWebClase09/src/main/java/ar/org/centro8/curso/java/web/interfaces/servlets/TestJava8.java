...
public class TestJava8 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            UserR.add(new User("2","Ramon", "ramon@gmail.com"));
            ...
            out.println("<br>2***********************************<br>");
            UserR.getAll().stream().map(User::getName).forEach(out::println);
            
            // select name,email from users;
            out.println("<br>3***********************************<br>");
            UserR
                .getAll()
                .forEach(item->out.println(item.getName()+" "+item.getEmail()+"<br>"));
            ...
            // select nombre from users where nombre like 'm%';
            out.println("<br>5***********************************<br>");
            ...
            UserR
                ...
                .forEach(item->out.println(item+" "+item.getEmail().hashCode()+"<br>"));
            ...
            // Comparable
            out.println("<br>9***********************************<br>");
            UserR.getAll().stream().sorted().forEach(out::println);
