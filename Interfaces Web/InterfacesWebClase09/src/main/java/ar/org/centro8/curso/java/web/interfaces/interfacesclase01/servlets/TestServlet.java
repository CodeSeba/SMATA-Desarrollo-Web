...
public class TestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Manejo de Exceptions con Try with resources   JDK 7
        try( PrintWriter out = response.getWriter() ){ 
            ...
            out.println("<h2>Servidor de Carlos</h2>");
            ...
            try {
                ...
                //http://localhost:8082/InterfacesClase02/TestServlet?nro1=4&nro2=9
            } catch (Exception e) {
                out.println("Formato de número incorrecto.");
                System.out.println("------------------------------------------");
            ...
            request
                    .getParameterMap()
                    .forEach((k,v)->out.println(k+" "+Arrays.toString(v)+"\n"));
